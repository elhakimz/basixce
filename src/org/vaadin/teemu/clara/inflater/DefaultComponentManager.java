...
public class DefaultComponentManager implements ComponentManager {
    ...
    void addAttributeParser(AttributeParser handler) {
    ...
    ComponentInstantiationException createException(Exception e,
    ...
    Class<? extends Component> resolveComponentClass(
    ...
    void handleAttributes(Component component,
                          Map<String, String> attributes) {
    ...
    void invokeWithAttributeFilters(final Method methodToInvoke,
    ...
    AttributeParser getHandlerFor(Class<?> type) {
