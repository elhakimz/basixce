 ...
 * Time: 1:56 AM
 */
public class AceGroovyEditor extends AceSuggestibleEditor {
    ...
    public AceGroovyEditor() {
        ...
        setSuggester(new GroovySuggester(), suggestAction);


    }

    private static class GroovyErrorChecker implements ErrorChecker {
        /* @Override */
    ...
    private static class GroovySuggester implements Suggester {
        /* @Override */
    ...
    ErrorCheckListener ecl = new ErrorCheckListener(this, new GroovyErrorChecker());
